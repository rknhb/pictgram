...
public class SocialUser implements OidcUser, OAuth2User, UserInf {
	...
	public SocialUser(Collection<? extends GrantedAuthority> authorities, Map<java.lang.String, java.lang.Object> attributes, String nameAttributeKey) {
		this.oauth2User = new DefaultOAuth2User(authorities, attributes, nameAttributeKey);
	}
	
	public SocialUser(Collection<? extends GrantedAuthority> authorities, Map<java.lang.String, java.lang.Object> attributes, String nameAttributeKey, Long userId) {
		this.oauth2User = new DefaultOAuth2User(authorities, attributes, nameAttributeKey);
		this.userId = userId;
	}
